...
namespace luareg {
	...
	{
		return def(name, (T*)nullptr, (R(T::*)(Args...))func);
	}
	...
	inline details::lua_function_t defLuaFunc(const char* name, details::lua_function_t::function_t func)
	{
		return details::lua_function_t(name, func);
	}

	template < class T >
	inline details::class_lua_function_t<T> defLuaFunc(const char *name, T *obj, typename details::class_lua_function_t<T>::function_t func)
	{
		return details::class_lua_function_t<T>(name, obj, func);
	}
